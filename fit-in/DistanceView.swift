            ...
            VStack {
                ...
                ZStack {
                    Chart {
                        ...
                        SectorMark(angle: .value(
                            Text(String(format: "%.1f meters left", user.gender ? (user.stepsTarget * 0.762) - steps * 0.762 : (user.stepsTarget * 0.67) - steps * 0.67)),
                            max(Int(user.stepsTarget) - Int(steps), 0)
                ...
                HStack {
                    Text("Meter")
                        ...
                        .italic()
                    Spacer()
                    Text(String(format: "%.1f", user.gender ? steps * 0.762 : steps * 0.67))
                        .font(.caption)
                        .fontWeight(.semibold)
                        .italic()
                }
